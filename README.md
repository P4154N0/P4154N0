...
* **2027 Target:** Oracle Certified Professional (OCP) Java SE 21 Developer Credential.
* **2028 Destination:** Software Development Academic Program at **SAIT (Calgary, AB, Canada)**.

### ⚙️ Hardware & Software Integration (The Bridge)
I leverage two decades of field experience in electromechanical systems and networking to build robust software. My focus is on **Java 21 (Virtual Threads for high-concurrency telemetry)**, **Spring Boot 3**, and **relational database architecture**, connecting edge hardware and sensors with cloud systems.

### 🛡️ Networks & Security Mindset
Having managed critical communications and network infrastructure, I prioritize security, resilience, and reliability in every REST API and database schema I design.

---

## 🌐 Socials:
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/hector-pablo-graff/) 

---

# 💻 Tech Stack:

### 🖥️ Programming Languages & Core
...
[![My Skills](https://skillicons.dev/icons?i=linux,debian,kali,arduino,raspberrypi,windows)](https://skillicons.dev)
